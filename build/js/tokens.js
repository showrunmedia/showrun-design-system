...
export const TypographyWeightLabel = "600"; // IBM Plex Mono 600 for labels; 700 for a cue state that must read as a command.
...
export const TypographyAxesMonoWeight = "100..700"; // Static instances, not a variable axis.
